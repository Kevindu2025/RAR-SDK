/*
 * unrar_dll_iface.h - UnRAR.dll compatible interface structures.
 * Verbatim structures from official unrarsrc/dll.hpp (freeware license).
 * Kept in a separate header so rarsdk.h stays stable.
 */
#ifndef UNRAR_DLL_IFACE_H
#define UNRAR_DLL_IFACE_H
